...
A partire dalla release 24,02, Astra Trident viene rilasciato ogni quattro mesi: Febbraio, giugno e ottobre. Questo è un mese dopo il rilascio di Kubernetes.
